...
const Header: React.FC = () => {
  ...
  "
              >
                ...
                .<br /> A Solução{" "}
                <span className="text-custom-text-title">Ideal</span> para
                <span className="text-custom-text-title">
                  {" "}
                  Construtoras
                </span> e{" "}
            ...
            "
              >
                Vou mostrar como você pode obter crédito ilimitado, baseado no
                empreendimento, sem a necessidade de investir recursos próprios
                e com prazos especiais.
              </p>
            </div>
            <div className="hidden md:flex md:w-[400px] lg:w-[500px] xl:w-full z-20">
              <Button
                label="Quero saber mais sobre essa modalidade de crédito - Incorporação."
                onClick={openModal}
              />
            </div>
          </div>
