...
const SectionTwo: React.FC = () => {
  ...
  "
    >
      ...
      >
        O crédito para{" "}
        <span className="text-custom-text-title">incorporação</span> é a opção
        mais <span className="text-custom-text-title">viável</span>,{" "}
      ...
      <p
        className="text-base text-center mt-4 font-normal text-white
            ...
            "
      >
        Outras opções de crédito inteligente incluem:
      </p>
